...
- Base: `node:22-alpine@sha256:9632533...`; builder `golang:1.25-alpine@sha256:261118...`.
- Glibc runner: `goneat-tools-runner-glibc` (Debian bookworm-slim base) with CGO build tooling.
...
- Current tools: syft (v1.18.1), grype (v0.86.1), trivy (v0.68.1); jq (1.7.1-r0), yq-go (4.44.5-r5), git (2.47.3-r0) for shaping outputs and CI checkouts.
- Base: `alpine:3.21@sha256:5405e8f3...`.
- Glibc runner: `sbom-tools-runner-glibc` (Debian bookworm-slim base) with CGO build tooling.
