...
sbom_alpine=$(get_version "alpine-base" "sbom-tools-slim")
sbom_syft=$(get_version "syft" "sbom-tools-slim")
sbom_grype=$(get_version "grype" "sbom-tools-slim")
sbom_trivy=$(get_version "trivy" "sbom-tools-slim")
sbom_jq=$(get_version "jq" "sbom-tools-slim")
sbom_yq=$(get_version "yq-go" "sbom-tools-slim")
sbom_git=$(get_version "git" "sbom-tools-runner")
sbom_curl=$(get_version "curl" "sbom-tools-runner")
...
goneat_go=$(get_version "golang-builder" "goneat-tools-slim")
goneat_prettier=$(get_version "prettier" "goneat-tools-slim")
goneat_biome=$(get_version "biome" "goneat-tools-slim")
goneat_yamlfmt=$(get_version "yamlfmt" "goneat-tools-slim")
goneat_shfmt=$(get_version "shfmt" "goneat-tools-slim")
goneat_checkmake=$(get_version "checkmake" "goneat-tools-slim")
goneat_actionlint=$(get_version "actionlint" "goneat-tools-slim")
goneat_jq=$(get_version "jq" "goneat-tools-slim")
goneat_yq=$(get_version "yq-go" "goneat-tools-slim")
goneat_ripgrep=$(get_version "ripgrep" "goneat-tools-slim")
goneat_taplo=$(get_version "taplo" "goneat-tools-slim")
goneat_minisign=$(get_version "minisign" "goneat-tools-slim")
goneat_goneat=$(get_version "goneat" "goneat-tools-slim")
goneat_sfetch=$(get_version "sfetch" "goneat-tools-slim")
goneat_bash=$(get_version "bash" "goneat-tools-runner")
goneat_git=$(get_version "git" "goneat-tools-runner")
goneat_curl=$(get_version "curl" "goneat-tools-runner")
